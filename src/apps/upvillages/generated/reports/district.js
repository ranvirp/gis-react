...
export const DistrictQuery = `query a {all_district { dname  district_code_census  dname_eng }  }`
export const DistrictFilterQuery = `query a($filter:String!) {district_by_filter(filter: $filter){ dname  district_code_census  dname_eng }  }`
...
const DistrictReportObject = new ReportObject(props.columns??DistrictColumns,DistrictQuery,{},(value)=>{
    ...
    const fn =  (value)=>{ 
         ...
         const comp = <DistrictCreateUpdateForm pk="district_code_census" defaultValues={myValue} />
