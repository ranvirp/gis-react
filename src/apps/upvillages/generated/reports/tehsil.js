...
export const TehsilQuery = `query a {all_tehsil {district_code{ dname  district_code_census  dname_eng }  tname  tehsil_code_census  tname_eng }  }`
export const TehsilFilterQuery = `query a($filter:String!) {tehsil_by_filter(filter: $filter){district_code{ dname  district_code_census  dname_eng }  tname  tehsil_code_census  tname_eng }  }`
const TehsilColumns = [
...
const TehsilReportObject = new ReportObject(props.columns??TehsilColumns,TehsilQuery,{},(value)=>{
    ...
    const fn =  (value)=>{ 
         ...
         const comp = <TehsilCreateUpdateForm pk="tehsil_code_census" defaultValues={myValue} />
