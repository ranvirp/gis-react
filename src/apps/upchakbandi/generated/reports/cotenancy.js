...
const CotenancyReportObject = new ReportObject(props.columns??CotenancyColumns,CotenancyFilterQuery,{"filter":props.filter},(value)=>{
   ...
   const fn =  (value)=>{ 
    ...
    return (
       <GenericReportWithStickyHead reportObject={CotenancyReportObject}/>
    )
}
export const CotenancyAll = (props) => {
const CotenancyReportObject = new ReportObject(props.columns??CotenancyColumns,CotenancyQuery,{},(value)=>{
    const results = value['all_cotenancy']
const fn =  (value)=>{ 
    if (props.fn) props.fn(value)
    return value}
...
export const CotenancyWithEdit = (props) => {
CotenancyColumns[0] = { id: 'editBtn',label: 'Action',minWidth: 10, align: 'center', format: (value) => value.toString()} 
...
const CotenancyReportObject = new ReportObject(props.columns??CotenancyColumns,CotenancyQuery,{},(value)=>{
    ...
    const fn =  (value)=>{ 
         ...
         const comp = <CotenancyCreateUpdateForm pk="id" defaultValues={myValue} />
...
export const CotenancyList = <GenericReportWithStickyHead reportObject={CotenancyReportObject}/>
