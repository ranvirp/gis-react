...
export const AuditlogsQuery = `query a {all_auditlogs { id  object_id  object_name  object_value  object_hash  type_of_action  hash_code  action_by  action_on }  }`
export const AuditlogsFilterQuery = `query a($filter:String!) {auditlogs_by_filter(filter: $filter){ id  object_id  object_name  object_value  object_hash  type_of_action  hash_code  action_by  action_on }  }`
...
const AuditlogsReportObject = new ReportObject(props.columns??AuditlogsColumns,AuditlogsQuery,{},(value)=>{
    ...
    const fn =  (value)=>{ 
         ...
         const comp = <AuditlogsCreateUpdateForm pk="id" defaultValues={myValue} />
