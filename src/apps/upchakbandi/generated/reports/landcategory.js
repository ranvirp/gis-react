...
export const LandCategoryQuery = `query a {all_land_category { code  category  category_eng  name  name_eng }  }`
export const LandCategoryFilterQuery = `query a($filter:String!) {land_category_by_filter(filter: $filter){ code  category  category_eng  name  name_eng }  }`
