...
export const createFarmerMutation = `mutation something($chakbandi:String!, $khatauni:String!, $unique_id:String!, $khatedar_code:String!, $mobile_no:String!, $name:String!, $minimized_name:String!, $name_eng:String!, $minimized_name_eng:String!, $relationship:String!, $relative_name:String!, $relative_name_minimized:String!, $year_of_birth:String!, $gender:String!, $address:String!){
        create_farmer(chakbandi: $chakbandi, khatauni: $khatauni, unique_id: $unique_id, khatedar_code: $khatedar_code, mobile_no: $mobile_no, name: $name, minimized_name: $minimized_name, name_eng: $name_eng, minimized_name_eng: $minimized_name_eng, relationship: $relationship, relative_name: $relative_name, relative_name_minimized: $relative_name_minimized, year_of_birth: $year_of_birth, gender: $gender, address: $address) {
            farmer {id chakbandi khatauni unique_id khatedar_code mobile_no name minimized_name name_eng minimized_name_eng relationship relative_name relative_name_minimized year_of_birth gender address }
          ok
          errormessage
...
const formFields = [FormField("chakbandi","Chakbandi"),FormField("khatauni","Khatauni"),FormField("unique_id","Unique Id"),FormField("khatedar_code","Khatedar Code"),FormField("mobile_no","Mobile No"),FormField("name","Name"),FormField("minimized_name","Minimized Name"),FormField("name_eng","Name Eng"),FormField("minimized_name_eng","Minimized Name Eng"),FormField("relationship","Relationship"),FormField("relative_name","Relative Name"),FormField("relative_name_minimized","Relative Name Minimized"),FormField("year_of_birth","Year Of Birth"),FormField("gender","Gender"),FormField("address","Address")]
...
export const FarmerCreateUpdateForm = (props)=> {
   ...
   //const myQuery = `query a{all_farmer { id chakbandi_id khatauni_id unique_id khatedar_code mobile_no name minimized_name name_eng minimized_name_eng relationship relative_name relative_name_minimized year_of_birth gender address status }}`
