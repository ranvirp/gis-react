...
export const FarmerCreateUpdateForm = (props)=> {
   ...
   const formFields = [FormField("id","Id"),FormField("chakbandi","Chakbandi"),FormField("khatauni","Khatauni"),FormField("khatedar_code","Khatedar Code"),FormField("name","Name",null,4),FormField("relationship","Relationship",null,4),FormField("relative_name","Relative Name",null,4),FormField("year_of_birth","Year Of Birth",null,4),FormField("gender","Gender",null,4),FormField("mobile_no","Mobile No",null,4),FormField("address","Address",null,12),FormField("unique_id","Unique Id",<input type={"hidden"} value={"00"}/>)]
   const mutation = props.edit? updateFarmerMutation:createFarmerMutation
   const formObject = new FormObject(defaultProps,defaultComponents,formFields,yupSchema,mutation,props.afterSubmitFn, props.variablesFn, props.debug)
